[mau.txt](https://github.com/user-attachments/files/23098186/mau.txt)
<!doctype html>
<html lang="vi">
<head>
  <meta charset="utf-8" />
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .video-wrapper{position:relative;padding-top:56.25%; /* 16:9 */ margin-top:12px;border-radius:8px;overflow:hidden}
    ...
    .lightbox-inner .caption{color:var(--dark);margin-bottom:8px}
...
<body>
  ...
  <main class="container">
    ...
    <section id="gioi-thieu" class="section" aria-labelledby="gioi-title">
      ...
      <ul>
        ...
        <li>Giá trị bền vững cho mọi công trình</li>
        <li>Dịch vụ tận tâm, giao hàng đúng hẹn</li>
      </ul>

      <!-- Embedded YouTube video (requested) -->
    ...
    <!-- DỊCH VỤ -->
    <section id="dich-vu" class="section" aria-labelledby="dich-title">
      <h2 id="dich-title">Dịch vụ</h2>
      <div class="cards">
        <div class="card"><h3>Tư vấn vật liệu</h3><p class="small">Gợi ý vật liệu phù hợp theo ngân sách và yêu cầu kỹ thuật.</p></div>
        <div class="card"><h3>Cung ứng & vận chuyển</h3><p class="small">Giao hàng nhanh, hỗ trợ bốc xếp tại công trình.</p></div>
        <div class="card"><h3>Lắp đặt thiết bị</h3><p class="small">Lắp đặt điện nước, nội thất, bảo hành chính hãng.</p></div>
        <div class="card"><h3>Bảo trì</h3><p class="small">Bảo dưỡng định kỳ hệ thống điện nước, thay thế linh kiện.</p></div>
      </div>
    </section>
    ...
    <section id="lien-he" class="section" aria-labelledby="lien-title">
      ...
      <div style="display:grid;grid-template-columns:1fr 320px;gap:20px">
        ...
        <aside style="background:var(--card);padding:14px;border-radius:10px;border:1px solid #eee">
          ...
          <p class="small">Hoặc gọi trực tiếp số Hotline để được tư vấn ngay.</p>
        </aside>
      </div>
    </section>
  </main>
  ...
  <footer class="site-footer">
    <div class="container">
      ...
      <p class="small">Địa chỉ: Yên Sơn, Thanh Hóa • Điện thoại: <a href="tel:0914414368">0914414368</a> • Hotline: <a href="tel:0944215456">0944215456</a></p>
    </div>
  </footer>
  ...
  <div id="lightbox" class="lightbox" role="dialog" aria-hidden="true" style="display:none;align-items:center;justify-content:center">
    <div class="lightbox-inner" role="document">
      ...
      <div style="margin-top:12px">
        <a id="lightboxContact" class="btn primary" href="#lien-he">Liên hệ mua</a>
      </div>
    </div>
  </div>
  ...
  <div id="cookieBanner" class="cookie-banner" style="position:fixed;bottom:16px;left:16px;right:16px;background:#222;color:#fff;padding:12px;border-radius:12px;display:flex;justify-content:space-between;align-items:center;z-index:140">
    ...
    <div>
      <button id="acceptCookies" class="btn">Đồng ý</button>
    </div>
  </div>
  ...
  <script>
    (function(){
      // Mobile menu toggle
      var mobileBtns = document.querySelectorAll('.mobile-toggle');
      mobileBtns.forEach(function(b){
      ...
      if(localStorage.getItem('hq_cookies')==='1'){
        cookieBanner.style.display='none';
      }
      if(accept){
        accept.addEventListener('click', function(){
          localStorage.setItem('hq_cookies','1');
          cookieBanner.style.display='none';
        });
      }
      ...
      var images = [
        {
          src: "https://files.oaiusercontent.com/file-90cfdb4d-924a-4a14-99b6-7c4c690e5f95/IMG_20231001_155708.jpg",
          caption: "Tranh kính nghệ thuật & Gạch lát sàn"
        },
        {
          src: "https://files.oaiusercontent.com/file-2b90f7b8-3b37-425d-bcf0-3b2d9b3aa31e/IMG_20231001_155730.jpg",
          caption: "Thiết bị chiếu sáng"
        },
        {
          src: "https://files.oaiusercontent.com/file-9e7c2a4a-7c41-48f7-8b42-6b5e6ee9e09f/IMG_20231001_155735.jpg",
          caption: "Thiết bị vệ sinh & điện nước"
        },
        {
          src: "https://files.oaiusercontent.com/file-7c6b7b7f-fbfb-4c7b-9c25-8613de8b8bb2/IMG_20231001_155658.jpg",
          caption: "Mặt tiền showroom Hưng Quế"
        }
      ];

      // Open lightbox when button clicked
      ...
      if(form){
        form.addEventListener('submit', function(e){
          e.preventDefault();
          // demo: no backend — just show alert and clear
          alert('Cảm ơn bạn! Thông tin đã được gửi. Chúng tôi sẽ liên hệ lại sớm.');
          form.reset();
        });
      }

      // Update nav active class on hash change / scroll to sections
